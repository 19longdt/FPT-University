...
import com.longdt.helloword.broadcast.BroadCastActivity;
import com.longdt.helloword.entity.Account;
import com.longdt.helloword.fragment.FragmentActivity;
...
public class Home extends AppCompatActivity {
    ...
    private void bindingAction() {
        ...
        btnBroadcast.setOnClickListener(view -> {
            Intent intent = new Intent(Home.this, BroadCastActivity.class);
            startActivity(intent);
        });
    }
